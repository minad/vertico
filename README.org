...
buffer, which is unwanted if you use the Vertico UI. See [[https://debbugs.gnu.org/cgi/bugreport.cgi?bug=74616][bug#74616]] for the
...
~tmm-menubar~, which is unnecessary with Vertico. See [[https://debbugs.gnu.org/cgi/bugreport.cgi?bug=74617][bug#74617]] for the upstream
