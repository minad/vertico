...
7. Install Embark-Consult for export from =consult-line= to editable =occur-mode=
   buffers and from =consult-grep= to =grep-mode= buffers. On Emacs 31 =grep-mode=
   buffers are editable. Use [[https://github.com/mhayashi1120/Emacs-wgrep][wgrep]] on older Emacs.
