...
- [[https://git.sr.ht/~protesilaos/mct][Mct]]: Minibuffer and Completions in Tandem. Mct reuses the default
  ...
  familiar buffer commands inside the completions buffer. The main distinction to
  ...
  ~mct-region-mode~. Note that Mct development is currently [[https://protesilaos.com/codelog/2022-04-14-emacs-discontinue-mct/][discontinued]] due to
...
- [[https://github.com/raxod502/selectrum][Selectrum]]: Selectrum is the predecessor of Vertico, since it directly inspired
  ...
  completion command and dynamic completion tables ([[https://github.com/raxod502/selectrum/issues/481][selectrum#481]]), since it uses
  ...
  Vertico ([[https://github.com/minad/vertico/issues/237][vertico#237]], [[https://github.com/radian-software/selectrum/issues/598][selectrum#598)]].
...
- [[https://github.com/SystemCrafters/crafted-emacs/blob/master/modules/crafted-completion.el][Crafted Emacs Completion Module]]: Vertico is used as completion system.
- [[https://protesilaos.com/emacs/dotemacs#h:c110e399-3f43-4555-8427-b1afe44c0779][Prot's Emacs configuration]]: Vertico is used as completion system.
