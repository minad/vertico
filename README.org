...
- [[https://github.com/radian-software/selectrum][Selectrum]]: Selectrum is the predecessor of Vertico, since it directly inspired
  Vertico. Vertico offers more flexibility thanks to its [[#extensions][extensions]]. Selectrum
  is not fully compatible with every Emacs completion command and dynamic
  completion tables ([[https://github.com/radian-software/selectrum/issues/481][selectrum#481]]), since it uses its own filtering
  ...
  ([[https://github.com/minad/vertico/issues/237][vertico#237]], [[https://github.com/radian-software/selectrum/issues/598][selectrum#598)]].
