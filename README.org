...
#+html: <a href="https://releases.melpa.org/#/vertico"><img alt="MELPA Releases" src="https://releases.melpa.org/packages/vertico-badge.svg"/></a>
#+html: <a href="https://snapshots.melpa.org/#/vertico"><img alt="MELPA Snapshots" src="https://snapshots.melpa.org/packages/vertico-badge.svg"/></a>
#+html: <img src="https://github.com/minad/vertico/blob/screenshots/movie.jpg?raw=true" align="right">
...
Vertico is available from [[https://elpa.gnu.org/packages/vertico.html][ELPA]] or [[https://releases.melpa.org/#/vertico][MELPA]]. You can install it directly via =M-x package-install RET vertico RET=.
...
Furthermore it is possible to install each of the files individually, ~vertico.el~
and the ~vertico-*.el~ extensions. Currently the following extensions come with
the Vertico package:
...
7. Install Embark-Consult to export from =consult-line= to editable =occur-mode=
   buffers and from =consult-grep= to =grep-mode= buffers. Install [[https://github.com/mhayashi1120/Emacs-wgrep][wgrep]] for editable
   Grep buffers, or use the less featureful =grep-edit-mode= on Emacs 31.
...
- [[https://github.com/protesilaos/mct][Mct]]: Minibuffer and Completions in Tandem. Mct reuses the default
...
- Configurations which use Vertico and Corfu for completion:
  ...
  + [[https://github.com/protesilaos/dotfiles/tree/master/emacs/.emacs.d][Prot's Emacs configuration]]
