...
Vertico is available from [[https://elpa.gnu.org/packages/vertico.html][ELPA]] or [[https://melpa.org/#/vertico][MELPA]]. You can install it directly via =M-x package-install RET vertico RET=.
