...
** Completion-at-point and completion-in-region
  ...
  This also affects TAB completion in the minibuffer when =M-:= (~eval-expression~) is used.
...
center of the screen, leading to a modern-looking IDE-like UI. Please give these
...
- [[https://github.com/tumashu/vertico-posframe][vertico-posframe]]: Display only the Vertico candidates in a child frame
...
* Alternatives
  ...
  - [[https://gitlab.com/protesilaos/mct][Mct]]: Minibuffer and Completions in Tandem. Reuses the default completions
